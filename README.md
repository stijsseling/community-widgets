This is a collection of custom widgets for [Glance](https://github.com/glanceapp/glance) made by the community using the `custom-api` widget.
...
* [Restic snapshot](widgets/restic-snapshot-by-not-first/README.md) by @not-first - show the most recent snapshot and storage stats of a restic repo
